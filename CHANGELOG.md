...
- **More materials**, in a material picker sorted into Basic, Metal, Stone, Natural and Special:
...
- **Shuffle pattern** gives a patterned material a new random layout: new grain, veins, speckles, chips, fibers or creases, new streaks for brushed metal, and a new spin center and hotspot for radial brushed metal. A duplicated shape gets its own layout, so copies don't look identical. The layout is saved with the project and is the same in every variant.
