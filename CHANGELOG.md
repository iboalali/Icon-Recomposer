...
- **Materials**, in a picker sorted into groups:
  ...
  - **Stone:** **marble** (dark or light veins that wander and swell), **granite**, **terrazzo** (chip color and amount), **slate**, **concrete** (with pits) and **stucco**, an irregular trowelled plaster relief lit by the scene light (**Relief depth** and, under Advanced, **Relief size**).
